...
/*                                                                           */
/*                                                                           */
/*  An expansion is represented by an array of floating-vertex numbers,       */
...
/*  floating-vertex arithmetic.  `epsilon' bounds the relative roundoff       */
/*  error.  It is used for floating-vertex error analysis.                    */
/*                                                                           */
/*  `splitter' is used to split floating-vertex numbers into two half-        */
/*  length significands for exact multiplication.                            */
/*                                                                           */
/*  I imagine that a highly optimizing compiler might be too smart for its   */
/*  own good, and somehow cause this routine to fail, if it pretends that    */
/*  floating-vertex arithmetic is too much like real arithmetic.              */
/*                                                                           */
